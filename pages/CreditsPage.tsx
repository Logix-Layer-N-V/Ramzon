...
import { Search, Filter, Plus, CreditCard, FileText, CheckCircle2, Pencil, ExternalLink, X, Coins, ChevronUp, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500 pb-10">
      <div className="flex justify-between items-end">
        ...
        <button onClick={() => navigate('/credits/new')} className="bg-orange-600 text-white px-5 py-2.5 rounded-xl text-sm font-black hover:bg-orange-500 transition-all flex items-center gap-2 shadow-xl active:scale-95">
